...
import com.qs.CriminalIntent.activities.CrimePagerActivity;
...
public class CrimeListFragment extends ListFragment {
    public static final String EXTRA_CRIME_ID = "com.qs.criminalintent.crime_id";
...
//        Intent i = new Intent(getActivity(), CrimeActivity.class);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        MenuItem showSubtitle = menu.findItem(R.id.menu_item_new_show_subtitle);
